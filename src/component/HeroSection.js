  ...
  return (
    <div className=" text-center  h-[100vh] bg-[url('/images/hotel.jpg')] bg-cover bg-center flex items-center text-black"id="home">
        <div>
            ...
            <h1 className='text-white bg-black/30 text-6xl  max-w-xl'>Experience luxury like  <span className='text-yellow-700'>never before</span></h1>
            ...
            <button className="text-white bg-yellow-600  mt-6  h-10 rounded-xl px-4 py-2 hover:decoration-yellow-400  hover:p-3" id="exploreRooms"> Explore room</button>
