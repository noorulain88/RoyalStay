...
export default function PoplarCard({ image, title, button, price }) {
  ...
  return (
    ...
    <div className="w-full  bg-white text-black  grid-cols-3 max-w-sm bg-neutral-primary-soft p-6   rounded-xl  p-4 shadow-md  hover:shadow-xl transition-shadow duration-300 hover:scale-105 "id="Rooms" >
      ...
      <button className='bg-yellow-700 hover:bg-yellow-600 text-white w-full mt-4 px-20 rounded-xl py-1 font-bold' onClick={showInfo}>
        {button}
      </button>
